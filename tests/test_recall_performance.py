...
class TestRecallPerformance:
    ...
    def test_recall_uses_index(self):
        ...
        assert any("test" in r.subject or "test" in r.predicate or "test" in r.object for r in results)
    ...
    def test_recall_correctness(self):
        ...
        assert all(
            "fruit" in r.subject.lower() or "fruit" in r.predicate.lower() or "fruit" in r.object.lower()
            for r in results
        )
